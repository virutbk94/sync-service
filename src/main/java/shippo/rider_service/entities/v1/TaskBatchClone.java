...
public class TaskBatchClone implements Serializable {
    ...
    public TaskBatchClone() {
    }

    public TaskBatchClone(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskBatchClone)) return false;
        TaskBatchClone taskBatch = (TaskBatchClone) o;
